...
let githubLink = "http://github.com/nhsevidence/viewer"

// Specify more information about your project
let info =
  [ "project-name", "viewer"
    "project-author", "Update Author in build.fsx"
    "project-summary", "A linked data viewer for the knowledge base project"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/viewer" ]
