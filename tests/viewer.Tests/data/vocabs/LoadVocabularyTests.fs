...
[<Tests>]
let tests =
  testList "Vocabulary building" [

    testCase "When parsing graph will return sorted tree" <| fun _ ->
    ...
    testCase "Should set vocab term as selected if url exists in filters" <| fun _ ->
